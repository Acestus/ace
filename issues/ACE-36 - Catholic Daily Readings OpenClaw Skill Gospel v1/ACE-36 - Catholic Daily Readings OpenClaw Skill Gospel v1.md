...
- [ ] When invoked (e.g. "give me today's reading"), the skill calls a
      ...
      ACE-33/34) that scrapes/parses today's Gospel reading from [USCCB.org](<http://USCCB.org>).
...
- [ ] Verified end-to-end: asking the local OpenClaw install for today's
      reading returns today's actual Gospel text, sourced live from [USCCB.org](<http://USCCB.org>)
...
WORKLOG: Stub created from Linear ACE-36
