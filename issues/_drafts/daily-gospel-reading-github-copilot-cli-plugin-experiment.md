...
USCCB.org and prints it in the terminal, backed by its own dedicated Azure
Function,
...
- [ ] The plugin is installable via `copilot plugin marketplace add
      <owner>/<repo>` per GitHub's documented plugin marketplace flow.
...
4. **End-to-end verification**
   - Install the plugin locally (`copilot plugin marketplace add
     <owner>/catholic-daily-copilot-plugin`) and confirm invoking it prints
